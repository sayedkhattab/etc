    ...
    <div class="hero-area-two bgs-cover overlay py-250" style="position: relative; overflow: hidden; direction: rtl;">
        ...
        <div class="container" style="position: relative; z-index: 1;">
            <div class="hero-content mt-110 rmt-0 mb-65 text-center text-white rel z-1">
                ...
                <form method="POST" action="{{ route('login') }}" enctype="multipart/form-data" style="margin-top: 25px !important; margin-bottom: 25px !important; background-color: rgba(var(--bs-light-rgb), var(--bs-bg-opacity)) !important; padding: 30px; border-radius: 15px; max-width: 80%; margin: auto;">
                    @csrf
