                ...
                <form method="POST" action="{{ route('register.student.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="national_id" type="text" class="form-control" style="direction: ltr;" name="national_id" required />
                        </div>

                        <div class="col-md-6">
                            <label for="email" class="form-label">البريد الالكتروني</label>
                            <input id="email" type="email" class="form-control" style="direction: ltr;" name="email" required />
                        </div>

                        <div class="col-md-6">
                            <label for="phone" class="form-label">رقم الهاتف</label>
                            <input id="phone" type="text" class="form-control" style="direction: ltr;" name="phone" required />
                        </div>
                        ...
                        <div class="col-md-6">
                            <label for="national_id_front" class="form-label">ارفق وجه الهوية</label>
                            <input id="national_id_front" type="file" class="form-control" name="national_id_front" required />
                        </div>

                        <div class="col-md-6">
                            <label for="national_id_back" class="form-label">ارفق ظهر الهوية</label>
                            <input id="national_id_back" type="file" class="form-control" name="national_id_back" required />
                        </div>

                        <div class="col-md-6">
                            <label for="password" class="form-label">كلمة المرور</label>
                            <input id="password" type="password" class="form-control" style="direction: ltr;" name="password" required />
                        </div>

                        <div class="col-md-6">
                            <label for="password_confirmation" class="form-label">تأكيد كلمة المرور</label>
                            <input id="password_confirmation" type="password" class="form-control" style="direction: ltr;" name="password_confirmation" required />
                        </div>
                    </div>
    ...
    @if (session('status'))
        ...
        <script>
            Swal.fire({
                ...
                text: "{{ session('status') }}",
                icon: 'success',
                confirmButtonText: 'انتقل للصفحة الرئيسية'
            }).then((result) => {
