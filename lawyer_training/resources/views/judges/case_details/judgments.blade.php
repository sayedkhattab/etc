                    ...
                    <div class="card-body" style="direction: ltr;">
                        <div class="row">
                            <div class="col-md-9" style="direction: rtl;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($judgment->file_path)
                                                        <a href="{{ route('judge.download.attachment', ['caseId' => $case->id, 'filename' => basename($judgment->file_path)]) }}" class="btn btn-primary mt-3">تحميل المرفق</a>
                                                    @else
                                                        لا يوجد مرفق
                                                    @endif
                                                </td>
                                ...
                                <form action="{{ route('judge.case_details.store_judgment', $case->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="content" class="form-label">نص الحكم:</label>
                                    ...
                                    <button type="submit" class="btn btn-success mt-3">حفظ الحكم</button>
                                </form>
                            </div>
