...
<div class="page-header d-flex justify-content-between align-items-center">
    <h1>إضافة سؤال للتقييم: {{ $assessment->title }}</h1>
    ...
    <div class="card-body">
        <form action="{{ route('admin.questions.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea name="question_text" class="form-control @error('question_text') is-invalid @enderror" rows="4" required>{{ old('question_text') }}</textarea>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="points" class="form-control @error('points') is-invalid @enderror" min="1" value="{{ old('points', 1) }}" required>
